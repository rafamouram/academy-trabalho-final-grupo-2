    ...
    Para registrar os produtos que desejo comprar
        ...
        @logarSite
           Scenario: Criando nova lista de compras sem itens
            ...
            Scenario Outline: Criando nova lista de compras com descrição
            ...
            Scenario Outline: Limite de uma lista de compras ativa por vez
            ...
            Scenario Outline: Criando nova lista de compras sem descrição
                When incluo uma lista de itens na lista de compras
                | nome       | <nome>       |
                | quantidade | <quantidade> |
                And salvo a lista de compras
